...
VERILOG_FILES = computer.v alu.v register.v pc.v instruction_memory.v mux2.v mux3.v mux4.v mux5.v mux6.v \
                data_memory.v status_register.v mux_data.v control_unit.v
